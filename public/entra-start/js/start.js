...
var vue_options = {
    ...
    methods: {
        ...
        start_authorize: async function(){
            ...
            new_win = open('/entra-login' + '?' + to_urlparam(params), null, 'width=400,height=750');
        },
        change_type: async function(){
            var result = await do_get('/entra/client_info', { tenant: this.tenant_type });
